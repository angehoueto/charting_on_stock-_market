# Technical Analysis
  ...
  Thechinical Analysis is a style of tradind opposed to fundamentals. One of the main techincal analysis strategy is chart analysis.That project will try to find keys level to take a trade on the stock market. That project will evlute and we will slowly add more charts figures.
   We will first try to find one of the most weel known wat to trade with chart analysis: _SUPPORT AND RESISTANCE_
   You got to buy a stock on a support level and to sell it on a resistance level. You can also wait the support(resitance) to be broke before selling(buying). As we always say. The trend is your friend.
